...
public final class Constants {
    ...
    // class to 600 - 2400 microseconds. However, the        // arm does have the ability to bind if the servos move past 
    ...
    // but do so with caution.        // Lift range 1000 - 1900 -> 0 - .722
    // Tilt range 1200 - 1900 -> .333 - .722
    // Gripper range 500 - 2400 -> 0 - 1
    public static final double LIFT_MIN = .333;
    public static final double LIFT_MAX = 0.722;
    public static final double TILT_MIN = .333;
    ...
    static final int SENSOR_CHANNEL = 0;
}
